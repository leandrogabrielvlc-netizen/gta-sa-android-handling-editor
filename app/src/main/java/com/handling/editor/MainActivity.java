...
public class MainActivity extends Activity {
    ...
    // =========================================================
    // CAMINHOS FIXOS DO GTA
    // =========================================================

    private static final String HANDLING_DATA_PATH =
        "/storage/emulated/0/Android/data/com.brp.game/files/data/handling.cfg";

    private static final String HANDLING_SAMP_PATH =
    ...
    private void iniciarShizuku() {
        ...
        try {
            ...
            if (
                ...
                ToastMessage(
                    "Solicitando permissão do Shizuku..."
                );
    ...
    private void conectarShizuku() {
        ...
        try {
            ...
            ToastMessage(
                "Não foi possível conectar ao Shizuku."
            );
        }
    }
    ...
    public void onRequestPermissionsResult(
        ...
        if (
            ...
            if (
                ...
                ToastMessage(
                    "Permissão do Shizuku não concedida."
                );
            }
        }
    }
    ...
    private void iniciarSubstituicao() {
        ...
        if (
            ...
            ToastMessage(
                "Dê permissão ao aplicativo no Shizuku."
            );
        ...
        new AlertDialog.Builder(this)
            ...
            .setMessage(
                "O handling.cfg atual será colocado diretamente em:\n\n"
                + "DATA:\n"
                + HANDLING_DATA_PATH
                + "\n\n"
                + "SAMP:\n"
    ...
    private String gerarHandlingFinal() {
